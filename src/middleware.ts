...
export function middleware(request: NextRequest) {
  ...
  const isPublic = pathname === "/" || pathname === "/login" || pathname === "/registro" || pathname === "/precios" || pathname.startsWith("/soluciones") || pathname.startsWith("/api/cron") || pathname.startsWith("/api/auth");
